...
st.caption("v2.8 - VOC exact merge A/B/G:H per reference file")
st.markdown("---")
...
# also add comma variants (1,2 vs 1.2)
for vs,grp,v in VOC_COMPOUND_ORDER:
    VOC_MAP[v.lower().replace(".",",")] = {"vs": vs, "grp": grp}
